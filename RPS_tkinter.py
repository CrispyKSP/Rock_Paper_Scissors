...
def old_user(window):
    ...
    welcome.grid(row=0, column=11, pady=10, sticky='nsew')

    ask_name = tk.Label(window, text='Please enter your username', fg=fg, bg=bg, anchor='center', font=font)
    ask_name.grid(row=1, column=11, pady=10, sticky='nsew')

    name = tk.Entry(window, fg='#202625', bg='#faddb6')
    name.grid(row=2, column=11, pady=10, sticky='nsew')

    enter_button = tk.Button(window, text='Done', command=lambda: file_data_accessing(window, name_s, stuff), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    enter_button.grid(row=3, column=15, pady=10, sticky='nsew')
...
def file_data_accessing(window, name, stuff):
    ...
    try:
        with open(name, "r") as file:
            ...
            display_1.grid(row=0, column=11, pady=10, sticky='nsew')

            display_2 = tk.Label(window, text='Your points %s ' % (user_data), fg= fg, bg= bg, anchor='center', font=font)
            display_2.grid(row=1, column=11, pady=10, sticky='nsew')

            display_3 = tk.Label(window, text='My points %s ' % (me_data), fg= fg, bg= bg, anchor='center', font=font)
            display_3.grid(row=2, column=11, pady=10, sticky='nsew')

            button = tk.Button(window, text='continue', command=lambda: RPS(window, name, bist), fg= fg, bg= bg, anchor='center', font=font, cursor='gobbler')
            button.grid(row=3, column=14, pady=10, sticky='nsew')
        ...
        button = tk.Button(window, text = 'Retry', command=lambda: retry(window, display, button), fg= fg, bg = bg, anchor='center', font=font, cursor='gobbler')
...
def RPS(window, name, bist):
    ...
    quit_button = tk.Button(window, text='quit', command=lambda: file_data_saving(window, name, disable), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    ...
    rock_button = tk.Button(window, text='rock', command=lambda: Rock(window, me_1, you_1, word2, word3, result_label, result_label1), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    rock_button.grid(row=4, column=3, pady=10, sticky='nsew')

    paper_button = tk.Button(window, text='paper', command=lambda: Paper(window, me_1, you_1, word2, word3, result_label, result_label1), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    paper_button.grid(row=4, column=7, pady=10, sticky='nsew')

    scissors_button = tk.Button(window, text='scissors', command=lambda: Scissors(window, me_1, you_1, word2, word3, result_label, result_label1), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
...
def file_data_saving(window, name, disable):
    ...
    you.grid(row=1, column=11, pady=10, sticky='nsew')

    me = tk.Label(window, text='My points : %s' %(user_data), fg=fg, bg=bg, anchor='center', font=font)
    me.grid(row=2, column=11, pady=10, sticky='nsew')

    done = tk.Button(window, text='Done', command= lambda : end(window), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    done.grid(row=3, column=15, pady=10, sticky='nsew')

    go_back = tk.Button(window, text='Return', command= lambda : RPS(window,name,bist), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    go_back.grid(row=3, column=7, pady=10, sticky='nsew') 
...
def no(window, intro, about, yes_button, no_button):
    ...
    enter_button = tk.Button(window, text='Done', command=lambda: new_user(window,welcome,ask_name,name,enter_button), fg=fg, bg=bg, anchor='center', font=font, cursor='gobbler')
    enter_button.grid(row=3, column=12, pady=10, sticky='nsew')
...
def main():
    ...
    intro.grid(row=0, column=11, pady=2, sticky='nsew')

    about = tk.Label(window, text='Are you an old user?', fg=fg, bg=bg, anchor='center',font=('Times New Roman', 13, 'bold'))
    about.grid(row=1, column=11, pady=2, sticky='nsew')
    
    yes_button = tk.Button(window, text='Yes', command=lambda: yes(window, intro, about, yes_button, no_button), fg=fg, bg=bg, height=1, width=3, cursor='gobbler')
    yes_button.grid(row=2, column=7, pady=2, sticky='nsew')
    
    no_button = tk.Button(window, text='No', command=lambda: no(window, intro, about, yes_button, no_button), fg=fg, bg=bg, height=1, width=3, cursor='gobbler')
    no_button.grid(row=2, column=15, pady=2, sticky='nsew')
